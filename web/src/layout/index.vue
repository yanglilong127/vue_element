...
//导入图组件
import barTypeData from '../components/echarts/barTypeData.vue';
import lineTypeData from '../components/echarts/lineTypeData.vue';
import ordertype from '../components/echarts/ordertype.vue';
import ordersource from '../components/echarts/ordersource.vue';
